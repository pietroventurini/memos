...
<a class="btn btn-primary float-btn float-btn-2" href="{{ route('groups.posts.create', ['group' => $group->id, 'type' => 'memo']) }}" alt="{{ __('home.memo.create') }}" role="button">
...
<a class="btn btn-primary float-btn" href="{{ route('groups.posts.create', ['group' => $group->id, 'type' => 'shoplist']) }}" alt="{{ __('home.shoplist.create') }}" role="button">
