...
<a class="btn btn-primary float-btn float-btn-2" href="{{ route('home') }}" alt="{{ __('home.memo.new') }}" role="button">
...
<a class="btn btn-primary float-btn" href="{{ route('home') }}" alt="{{ __('home.shoplist.new') }}" role="button">
