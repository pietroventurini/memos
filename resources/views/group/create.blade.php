                        ...
                        <form class="needs-validation" action="{{ route('groups.store') }}" method="POST">
                            ...
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                    <label for="input-name">{{ __('home.name') }}</label>
                                    <input type="text" class="form-control" id="input-name" name="name" aria-describedby="nameHelpBlock" required>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="input-description">{{ __('home.description') }}</label>
                                    <input type="text" class="form-control" id="input-description" name="description" aria-describedby="descHelpBlock">
